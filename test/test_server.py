...
class TestServerRealSeq(unittest.TestCase):
    ...
    def test_TG_github_all_resources(self):
        ...
        response = server.get('/%s/https://raw.githubusercontent.com/mementoweb/timegate/master/core/handler/example3.py' % TIMEGATE_URI_PART, headers=ad, status=302)
        response = server.get('/%s/https://github.com/mementoweb/timegate/blob/master/core/handler/example3.py' % TIMEGATE_URI_PART, headers=ad, status=302)
    ...
    def test_TM_github_all_resources(self):
        ...
        response = server.get('/%s/https://raw.githubusercontent.com/mementoweb/timegate/master/core/handler/example3.py' % TIMEMAP_URI_PART, headers=ad, status=200)
        response = server.get('/%s/https://github.com/mementoweb/timegate/blob/master/core/handler/example3.py' % TIMEMAP_URI_PART, headers=ad, status=200)
    ...
    def test_github_404s(self):
        ...
        response = server.get('/%s/https://raw.githubusercontent.com/mementoweb/tim/egate/master/core/handler/example3.py' % TIMEMAP_URI_PART, headers=ad, status=404)
        response = server.get('/%s/https://github.com/mementoweb/timegate/blob/master/core/handler/exajmple3.py' % TIMEMAP_URI_PART, headers=ad, status=404)
